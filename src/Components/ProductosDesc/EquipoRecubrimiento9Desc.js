...
import imgPruebaa from '../../img/productos/Equipos de pintura/Equipos de recubrimiento/9.-Bombas Binks MX412.jpg';
  ...
  return (
    <div className='herramientaElectricaBateria1Desc'>
      ...
      <div className='herramientaElectricaBateria1Desc_right'>
        <h2>Bombas Binks MX412</h2><br/>
        <p><strong>SKU:</strong>  MX412</p>
...
Consumo Aire a 20 ciclos/min 2.2 SCFM
          </p>
        </div>
<br/>
