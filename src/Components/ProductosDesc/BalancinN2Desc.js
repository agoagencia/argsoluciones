...
import imgPruebaa from '../../img/productos/manejoDeMateriales/BalancinesNeumaticos/2.-Balancin neumatico BW035080.jpg';
  ...
  return (
    <div className='herramientaElectricaBateria1Desc'>
      ...
      <div className='herramientaElectricaBateria1Desc_right'>
        <h2>Balancin neumático BW035080</h2><br/>
        <p><strong>SKU:</strong> BW035080</p>
