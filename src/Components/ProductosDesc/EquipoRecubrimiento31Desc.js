...
import imgPruebaa from '../../img/productos/Equipos de pintura/Equipos de recubrimiento/31.-Tanque de presión Binks Serie 183S.jpg';
  ...
  return (
    <div className='herramientaElectricaBateria1Desc'>
      ...
      <div className='herramientaElectricaBateria1Desc_right'>
        <h2>Tanque de presión Binks Serie 183S</h2><br/>
        <p><strong>SKU:</strong> 183S</p>
