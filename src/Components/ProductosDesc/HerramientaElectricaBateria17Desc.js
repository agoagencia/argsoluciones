...
import imgPruebaa from '../../img/productos/HerramientaElectrica/herramientaElectricaBateria/17.-Llave de trinquete de 3-8” R3130.jpg';
  ...
  return (
    <div className='herramientaElectricaBateria1Desc'>
      ...
      <div className='herramientaElectricaBateria1Desc_right'>
        <h2>Llave de trinquete de 3/8″ R3130</h2><br/>
        <p><strong>SKU:</strong>  R3130</p>
