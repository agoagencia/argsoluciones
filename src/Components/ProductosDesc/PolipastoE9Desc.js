...
import imgPruebaa from '../../img/productos/manejoDeMateriales/PolipastosElectricos/9.-Trolley-(motorized).jpg';
  ...
  return (
    <div className='herramientaElectricaBateria1Desc'>
      ...
      <div className='herramientaElectricaBateria1Desc_right'>
        <h2>Trolley-(motorized)</h2><br/>
        <p><strong>SKU:</strong> Serie ET Electrico</p>
