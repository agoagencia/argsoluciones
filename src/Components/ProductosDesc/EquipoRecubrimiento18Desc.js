...
import imgPruebaa from '../../img/productos/Equipos de pintura/Equipos de recubrimiento/18.-Pistola automática A-G361 DeVilbiss.jpg';
  ...
  return (
    <div className='herramientaElectricaBateria1Desc'>
      ...
      <div className='herramientaElectricaBateria1Desc_right'>
        <h2>Pistola automática A-G361 DeVilbiss</h2><br/>
        <p><strong>SKU:</strong> AG361</p>
