...
import imgPruebaa from '../../img/productos/Equipos de pintura/Equipos automatizados/4.-Sistema de dosificacion Promix 2KS Automatico.jpg';
  ...
  return (
    <div className='herramientaElectricaBateria1Desc'>
      ...
      <div className='herramientaElectricaBateria1Desc_right'>
        <h2>Sistema de dosificacion Promix<br/>2KS Automatico</h2><br/>
        <p><strong>SKU:</strong> Promix 2KS Automatico</p>
        <p><strong>Categorías:</strong> Equipos automatizados, Graco</p>
        <br />
        <div className='HerramientaElectricaBateria1Descripcion'>
          <h2>Descripción</h2>
          <p>
          Dosificador electrónico para una amplia gama de materiales de medio solvente, medio acuoso y catalizados con ácido
          </p><br/><br/>
...
Rango de proporción de mezcla: 0.1:1?50:1<br/><br/>
...
Filtración de fluidos (proporcionada por el usuario): M?nimo de malla 100<br/><br/>
