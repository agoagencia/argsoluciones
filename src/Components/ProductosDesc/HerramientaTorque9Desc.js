...
import imgPruebaa from '../../img/productos/Herramienta de Torque/ELEVADORA.png';
...
Fabricación con estricto control de calidad.<br/><br/>
Cumple con las especificaciones de la industria automotriz.<br/><br/>
Control standard de pedestal.
          </p><br/><br/>
